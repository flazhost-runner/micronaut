...
public final class NettyHttpClientBuilder {
    ...
    static NettyHttpClientBuilder from(DefaultHttpClientBuilder builder) {
        NettyHttpClientBuilder nettyBuilder = new NettyHttpClientBuilder();
        nettyBuilder.loadBalancer = builder.loadBalancer;
        nettyBuilder.explicitHttpVersion = builder.explicitHttpVersion;
        nettyBuilder.configuration = builder.configuration;
        nettyBuilder.contextPath = builder.contextPath;
        nettyBuilder.annotationMetadataResolver = builder.annotationMetadataResolver;
        nettyBuilder.filterResolver = builder.filterResolver;
        nettyBuilder.clientFilterEntries = builder.clientFilterEntries;
        nettyBuilder.threadFactory = builder.threadFactory;
        nettyBuilder.nettyClientSslBuilder = builder.nettyClientSslBuilder;
        nettyBuilder.sslFactory = builder.sslFactory;
        nettyBuilder.certificateProviders = builder.certificateProviders;
        nettyBuilder.codecRegistry = builder.codecRegistry;
        nettyBuilder.handlerRegistry = builder.handlerRegistry;
        nettyBuilder.webSocketBeanRegistry = builder.webSocketBeanRegistry;
        nettyBuilder.requestBinderRegistry = builder.requestBinderRegistry;
        nettyBuilder.eventLoopGroup = builder.eventLoopGroup;
        nettyBuilder.socketChannelFactory = builder.socketChannelFactory;
        nettyBuilder.udpChannelFactory = builder.udpChannelFactory;
        nettyBuilder.clientCustomizer = builder.clientCustomizer;
        nettyBuilder.informationalServiceId = builder.informationalServiceId;
        nettyBuilder.conversionService = builder.conversionService;
        nettyBuilder.resolverGroup = builder.resolverGroup;
        nettyBuilder.blockingExecutor = builder.blockingExecutor;
        return nettyBuilder;
    }
