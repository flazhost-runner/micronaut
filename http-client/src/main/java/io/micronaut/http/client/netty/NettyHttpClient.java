 ...
 */
@Internal
@SuppressWarnings({"checkstyle:FileLength", "checkstyle:ParameterNumber"})
public class NettyHttpClient implements
        WebSocketClient,
        HttpClient,
        StreamingHttpClient,
        SseClient,
     ...
     */
    @Deprecated
    public NettyHttpClient(@Nullable LoadBalancer loadBalancer,
     ...
     */
    @Deprecated
    public NettyHttpClient(@Nullable URI uri) {
     ...
     */
    @Deprecated
    public NettyHttpClient(@Nullable URI uri, HttpClientConfiguration configuration) {
        this(
            builder()
                .uri(uri)
                .configuration(configuration)
     ...
     */
    @Deprecated
    public NettyHttpClient(@Nullable URI uri, HttpClientConfiguration configuration, ClientSslBuilder clientSslBuilder) {
        this(
            builder()
                .uri(uri)
                .configuration(configuration)
     ...
     */
    @Deprecated
    public NettyHttpClient(@Nullable LoadBalancer loadBalancer, HttpClientConfiguration configuration) {
        this(
            builder()
                .loadBalancer(loadBalancer)
                .configuration(configuration)
    ...
    /**
     * Create a new builder for a {@link NettyHttpClient}.
     *
     * @return The builder
     * @since 4.7.0
     */
    ...
    public BlockingHttpClient toBlocking() {
        return new BlockingHttpClient() {
            ...
            public <I, O, E> O retrieve(io.micronaut.http.HttpRequest<I> request, Argument<O> bodyType, Argument<E> errorType) {
                ...
                return HttpClientResponseBodyHandler.requireBody(response, bodyType, NettyHttpClient.this::decorate);
            }
